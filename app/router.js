  ...
  return exports.tohken.router = function(request, action) {
    ...
    switch (action) {
      ...
      case 'user/profile':
        return this.parser(request, (function(_this) {
          return function(data) {
            _this.data['player']['world'] = data['world'];
			_this.data['player']['now_sword'] = sword_num;
			_this.data['player']['world'] = world;
			_this.data['player']['created_at'] = created_at;
			_this.data['player']['complete'] = complete;
			_this.data['player']['summary'] = summary;
			return exports.tohken.parse.view.call(_this, 'player');
          };
        })(this));
      case 'forge':
        return this.parser(request, (function(_this) {
