(function(exports) {
  ...
  if (!exports.tohken.parse) {
   ...
   exports.tohken.parse.player = function(player) {
    this.data['player']['filling'] = true;
    this.data['player']['now_sword'] = sword_num;
    this.data['player']['world'] = world;
    this.data['player']['created_at'] = created_at;
    this.data['player']['complete'] = complete;
	this.data['player']['summary'] = summary;
	this.data['player']['last_update'] = Date.now();
    return 'done';
  };
        ...
        switch (n['type']) {
          case 'equip':
            ...
            _this.sendMessage({
              type: 'notify',
              message: {
                title: exports.tohken.define.tohkens[n['sword']]['name'] + "'s troops just fell!",
            ...
            switch (n['value']) {
              case 0:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: exports.tohken.define.tohkens[n['sword']]['name'] + " lost some blood!",
                    message: "Pay attention to damage, your swords might break.",
                    context: "Notification can be set in Settings."
                  }
                });
              ...
              case 1:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: exports.tohken.define.tohkens[n['sword']]['name'] + " is lightly bruised!",
                     message: "Pay attention to damage, your swords might break.",
                     context: "Notification can be set in Settings."
                  }
                });
              ...
              case 2:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: exports.tohken.define.tohkens[n['sword']]['name'] + " is moderately injured!",
                     message: "Pay attention to damage, your swords might break.",
                     context: "Notification can be set in Settings."
                  }
                });
              ...
              case 3:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: exports.tohken.define.tohkens[n['sword']]['name'] + " is severely wounded!!",
                     message: "Pay attention to damage, your swords might break.",
                     context: "Notification can be set in Settings."
                  }
                });
    ...
    _.forEach(party, (function(_this) {
      return function(v, k) {
        ...
        if (f !== null) {
          ...
          fd.setTime(finish);
          earlier = 0;
          title = v['party_name'] + "'s returned from expedition!";
          message = "End time " + (fd.getHours()) + ":" + (fd.getMinutes()) + ":" + (fd.getSeconds());
          ...
          switch (_this.config['notify_conquest']) {
            case 0:
              return;
            case 1:
              title = v['party_name'] + "'s expedition will end in 5min.";
              cmsg = "Notification can be set in Settings.";
              earlier = 5 * 60 * 1000;
              break;
            case 2:
              title = v['party_name'] + "'s expedition will end in 2min.";
              cmsg = "Notification can be set in Settings.";
              earlier = 2 * 60 * 1000;
              break;
            case 3:
              title = v['party_name'] + "'s expedition will end in 30 sec.";
              cmsg = "Notification can be set in Settings.";
              earlier = 0.5 * 60 * 1000;
          }
          _this.sendMessage({
            ...
            'startmsg': {
              'title': v['party_name'] + " are going on expedition.",
              'message': message,
              'context': cmsg
            }
          });
        ...
        if (f !== null) {
          ...
          switch (_this.config['notify_conquest']) {
            case 0:
              return;
            case 1:
              title = v['party_name'] + " will be fixed in 5min.";
              cmsg = "Notification can be set in Settings.";
              earlier = 5 * 60 * 1000;
              break;
            case 2:
              title = v['party_name'] + " will be fixed in 2min.";
              cmsg = "Notification can be set in Settings.";
              earlier = 2 * 60 * 1000;
              break;
            case 3:
              title = v['party_name'] + " will be fixed in 30 sec.";
              cmsg = "Notification can be set in Settings.";
              earlier = 0.5 * 60 * 1000;
          }
          _this.sendMessage({
            ...
            'startmsg': {
              'title': exports.tohken.define.tohkens[_this.data['sword']['data'][v['sword_serial_id']]['sword_id']]['name'] + " is now being repaired.",
              'message': message,
              'context': cmsg
            }
          });
