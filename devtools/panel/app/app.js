  ...
  return exports.tohken.control = new Vue({
    ...
    filters: {
      ...
      e2n: function(equip_id) {
        return exports.tohken.define.equip[equip_id]['name'];
      },
      ls2t: function(time) {
      ...
      ls2n: function(sword_id) {
        ...
        return exports.tohken.define.tohkens[sword_id]['name'];
      },
      ...
      sid2n: function(sid) {
        return exports.tohken.define.tohkens[this.data['sword']['data'][sid]['sword_id']]['name'];
      }
    },
    methods: {
